...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 410.0, 325.0, 22.0 ],
					"text" : "routing-objects available_routing_channels routing_channel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 370.0, 286.0, 22.0 ],
					"text" : "routing-objects available_routing_types routing_type"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/max/max-experiments/xfader",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
